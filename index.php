    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: Shell Corp<br>
            Marsa
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0123456789">29291079/a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:support@ShellCorp.com" class="email__addr">support@ShellCorp.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> Shell Corp&trade;
          </div>

          <div class="developer">
            Developed by Aziz Fehmi
          </div>

          <div class="designby">
            Design by Aziz Fehmi
          </div>
